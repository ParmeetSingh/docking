...
import pickle
from utils import WeightReader, decode_netout, draw_boxes,Message1,Message2
...
with open('yolo_mobilenetv2.cfg','rb') as f:
    cfg = pickle.load(f)
    model = model_from_json(cfg)
    

with open('yolo_mobilenet_weightsv2.hd5','rb') as f:
...
while success:
    ...
    try:
        ...
        boxes = decode_netout(netout[0],obj_threshold=0.3,nms_threshold=0.2,anchors=ANCHORS,nb_class=CLASS)            
